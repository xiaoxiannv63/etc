...
require('../../components/keyboard/keyboard.js?appxworker=1');
...
require('../../pages/loading/home.js?appxworker=1');
require('../../pages/startup/startup.js?appxworker=1');
require('../../pages/index/index.js?appxworker=1');
require('../../pages/mtc/recordList/recordList.js?appxworker=1');
...
require('../../pages/mtc/recordConfirm/recordConfirm.js?appxworker=1');
require('../../pages/mtc/addLicensePlate/addLicensePlate.js?appxworker=1');
require('../../pages/mtc/confirmSuccess/confirmSuccess.js?appxworker=1');
require('../../pages/mtc/certification/certification.js?appxworker=1');
require('../../pages/mtc/infoInput/infoInput.js?appxworker=1');
require('../../pages/mtc/invoiceDetail/invoiceDetail.js?appxworker=1');
require('../../pages/mtc/infoFail/infoFail.js?appxworker=1');
require('../../pages/mtc/infoSuc/infoSuc.js?appxworker=1');
require('../../pages/mtc/viewInvoice/viewInvoice.js?appxworker=1');
require('../../pages/mtc/infoConfirm/infoConfirm.js?appxworker=1');
require('../../pages/mtc/invoiceSuccess/invoiceSuccess.js?appxworker=1');
require('../../pages/changeSuccess/changeSuccess.js?appxworker=1');
require('../../pages/mtc/selTaitou/selTaitou.js?appxworker=1');
}
