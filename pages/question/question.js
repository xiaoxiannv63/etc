Page({
  data: {
    items: [{
      ...
      name: "2、ETC卡", content: [{
        ...
        answer: '已办理ETC卡的用户可直接通过票根平台 www.txffp.com、“票根APP”或“票根小程序”开具通行 费电子发票。'
      }, {
        expanded: false,
        id: "2.2",
        question: '2.2、未办理ETC卡',
        answer: '未办理ETC卡的用户可联系ETC卡的发行方咨询新办手续。或直接通过“支付宝-ETC服务”小程序进行办理。\n 各省发行方热线电话如下：\n 北京：010-96011; 天津：4007554007; 河北：0311- 96122转ETC;山西：0351-7337793;内蒙古： 0471-12122;辽宁：024-96199;吉林：0431- 12122;黑龙江：0451-96369;上海：021-12319; 江苏：025-96777;浙江：0571-88891122;安徽： 0551-96369;福建：0591-12122;江西：0791- 86130100;山东：0531-96669转2;河南：0371- 12328;湖北：027-96576;湖南：0731- 12328/96528;广东：020-96533;广西：0771- 96333转2;重庆：023-12122;四川：028-12122; 贵州：0851-12328;云南：0871-64611156/0871- 12328;陝西：029-12122;甘肃：0931-12328;青 海：0971-6231000;宁夏：0951-12328;新疆： 0991-12328 '
      }]
    },
    {
      name: "3、注册或登录票根账号", content: [{
        ...
        answer: '-老用户：可通过登录原票根账号开具电子发票。\n -新用户：只需输入手机号或使用支付宝授权登录，完成注册即可正常使用。'
      },
    {
      expanded: false,
      id: '3.2',
      question: '3.2、如何登录票根账号？',
      answer: '在首页选择【票根注册用户登录】，输入注册手机号及密码，即可登录成功。如您忘记密码，可选择【使用手机验证码登录】，输入注册手机号及收到的短信验证码，即可登录成功。短信验证码限定5分钟内只可获取一次。'
    },
    {
      expanded: false,
      id: '3.3',
      question: '3.3、忘记密码如何登录票根账号？',
      answer: '如您忘记密码，可选择【使用手机验证码登录】，输入注 册手机号及收到的短信验证码，即可登录成功。短信验证 码限定5分钟内只可获取一次。'
    },
    {
      expanded: false,
      id: '3.4',
    ...
    },
    {
      ...
      answer: '-2018年1月1日前注销的ETC卡是不可以再通过平台进行绑定的，平台只能开具2018年1月1日之后的发票。\n -2018年1月1日之后注销的ETC卡是可以绑定的，绑定后您 也可以开具您这张卡上2018年1月1日之后的消费记录发'
    }, {
      expanded: false,
      id: '4.7',
  ...
  },
  {
    name: "5、关联抬头", content: [{
      ...
      answer: '根据相关要求，通行或充值前必须预设发票抬头，一旦交易完成，该次发票抬头不可更改，建议您在每次通行或充值前主动检查卡片关联的发票抬头，以免产生错误发票。'
    },
    {
      expanded: false,
      id: '5.2',
  ...
  },
  {
    name: "6、我要开票", content: [{
      ...
      id: '6.1',
      question: '6.1、如何幵票',
      answer: '6.1.1、	选择需开票的ETC卡；\n 6.1.2、	选择通行记录（开具消费发票）；选择充值交易记录 (开具充值发票）；\n 6.1.3、	填写或核对电子邮箱，即可提交开票申请。\n注：电子发票可以电子形式保存，不打印也可报销、抵扣。'
    }, {
      expanded: false,
      id: '6.2',
      question: '6.2、在票根上我可以幵具什么发票？',
      answer: '-充值发票：充值记录会在实际充值后24小时内上传至发票平台，上传后可以选择获取不征税的充值发票。\n -消费发票：通行记录会在实际通行后第10个自然日（遇法定节假日顺延）上传至发票平台，上传后可以获取相应消费发票。'
    }, {
      expanded: false,
      id: '6.3',
      question: '6.3、票根上幵具的电子发票可以抵税吗？',
      answer: '如果您通行的是经营性公路，开具的消费发票左上角带有通行费字样，发票抬头信息填写完整，属于征税发票，具备抵扣功能。'
    }, {
      expanded: false,
      id: '6.4',
      question: '6.4、为什么找不到通行记录？',
      answer: '您可在实际发生通行费用后的第10个自然日起（遇法定 节假日顺延），在票根上申请开具消费发票；如超过10 个自然日仍未找到通行记录，请联系通行省份客服。'
    }, {
      expanded: false,
      id: '6.5',
      ...
      expanded: false,
      id: '6.6',
      question: '6.6、可以选择多条行程记录批量幵票吗？',
      answer: '-您可选择同一月份的多条交易进行批量开票；\n-如需查询不同月份的行程记录，请点击时间控件切换月份。'
    }, {
      expanded: false,
      id: '6.7',
      question: '6.7、可以选择多条充值记录批量幵票吗？',
      answer: '-您可选择同一月份的多条交易进行批量开票；\n -如需查询不同月份的行程记录，请点击时间控件切换月份。'
    }, {
      expanded: false,
      id: '6.8',
      question: '6.8、为什么幵出来多张发票？',
      answer: '我国高速公路有经营性和还货性两种，消费发票是由您通行路段的道路方给您开具。如果您的通行交易是同一道路业主，且税号、所选交易商品编码相同，是可以进行合并开票的。如果您的通行交易涉及不同道路业主或不同道路性质，就会产生多张发票。'
    }, {
      expanded: false,
      id: '6.9',
      question: '6.9、什么是可幵票金额？',
      answer: '可开票金额是ETC储值卡可以在票根上开具发票的额度， 充值后可开票金额会相应增加相应的充值金额；开具消费或充值发票后可开票金额会根据发票金额做相应扣减。'
    }, {
      expanded: false,
      id: '6.10',
      question: '6.10、线下现金缴费的交易可以幵发票吗？',
      ...
      expanded: false,
      id: '6.12',
      question: '6.12、提示“税务信息变更无法幵票”怎么办？',
      answer: '如开票时提示“因道路业主税务信息变更，暂时无法开 票，预计**月**日左右恢复开票。”超过**月**日仍无法 开票，请您联系在线客服处理。'
    }, {
      expanded: false,
      id: '6.13',
      question: '6.13、提示“票量不足无法幵票”怎么办？',
      answer: '如开票时提示“因道路业主票量不足，暂时无法开票，预 计**月**日左右恢复开票。”超过**月**日仍无法开票，请您联系在线客服处理。'
    }, {
      expanded: false,
      id: '6.14',
      question: '6.14、提示“未及时报税无法幵票”怎么办？',
      answer: '如开票时提示“因道路业主未及时报税，暂时无法开票， 预计**月**日左右恢复开票。”超过**月**日仍无法开 票，请您联系在线客服处理。'
    }]
  },
  {
    name: "7、开票记录", content: [{
      expanded: false,
      id: '7.1',
      question: '7.1、是否可以查询绑卡前的幵票记录？',
      answer: '可以查询到绑卡前的开票记录。只要您是2018年1月1日 后进行的ETC充值或通行收费公路，且交易记录已上传至发票平台，您绑卡后就可查询并开具相应的发票。'
    }, {
      expanded: false,
      id: '7.2',
      question: '7.2、幵票申请一直处于“幵票中”怎么办？',
      answer: '若您的开票申请在提交24小时后仍处于“开票中”状态， 请您联系在线客服处理。'
    }, {
      expanded: false,
      id: '7.3',
      question: '7.3、显示“幵票完成“，但收不到电子发票怎么办？',
      answer: '-请先尝试检查邮件垃圾箱，是否有电子发票邮件；\n-如果在邮箱、支付宝卡包、支付宝电子发票管家和票根小程序中仍无法找到电子发票，请您联系在线客服处理。'
    }, {
      expanded: false,
      id: '7.4',
      question: '7.4、如何下载电子发票？',
      answer: '您可通过邮件、支付宝卡包、支付宝发票管家或在小程序内下载电子发票，其中在小程序内下载电子发票请按照如下操作：\n1.	在“开票详情”页面点击【查看全部电子发票】按钮；\n2.	在“查看电子发票”页面点击【预览电子发票】按钮；\n3.	长按发票进行保存。'
    }, {
      expanded: false,
      id: '7.5',
      question: '7.5、自行打印的电子发票是否有效？',
      answer: '目前国税政策规定，自行打印的电子发票与纸质发票具有同等法律效力。'
    }, {
      expanded: false,
      id: '7.6',
      question: '7.6、如何判断电子发票是否可抵税？',
      answer: '充值发票：不具备抵扣功能；\n消费发票：如果通行经营性公路，开具的消费发票左上角带有“通行费”字样，发票抬头信息填写完整，具备抵扣 功能；如果通行还货性公路，开具的消费发票左上角 无“通行费”字样，就不具备抵扣功能。'
    }, {
      expanded: false,
      id: '7.7',
      question: '7.7、车辆类型或车牌号码与实际不符怎么办？',
      answer: '-车辆类型或车牌号码错误，建议您到ETC发行网点核实车辆信息并更正，在正确车辆信息上传后，再登录发票服务平台开具发票；\n-已开具的发票票面上显示的车辆类型或车牌号码有误，建议您到ETC发行网点核实车辆信息并更正，在正确车辆 信息上传后，您可在“票根”网站（www.txffp.com)进 行【申请红冲】操作，再开具对应的发票。如在处理过程中遇到问题，请您联系在线客服处理。'
    }]
  },
  {
    name: "8、卡片管理", content: [{
